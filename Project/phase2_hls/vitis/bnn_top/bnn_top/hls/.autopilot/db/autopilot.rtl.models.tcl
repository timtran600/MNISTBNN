set SynModuleInfo {
  ...
  {SRCNAME bnn_top MODELNAME bnn_top RTLNAME bnn_top IS_TOP 1
    SUBMODULES {
      {MODELNAME bnn_top_bnn_top_stream_ap_uint_ap_uint_ap_uint_ap_uint_ap_uint_local_l1_weights_3_RAMbkb RTLNAME bnn_top_bnn_top_stream_ap_uint_ap_uint_ap_uint_ap_uint_ap_uint_local_l1_weights_3_RAMbkb BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME bnn_top_bnn_top_stream_ap_uint_ap_uint_ap_uint_ap_uint_ap_uint_local_l2_weights_3_RAMfYi RTLNAME bnn_top_bnn_top_stream_ap_uint_ap_uint_ap_uint_ap_uint_ap_uint_local_l2_weights_3_RAMfYi BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
