set moduleName bnn_top_Pipeline_L3_NEURON
set isTopModule 0
...
set C_modelName {bnn_top_Pipeline_L3_NEURON}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_l3_weights { MEM_WIDTH 256 MEM_SIZE 320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ l3_input int 256 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "l3_input", "interface" : "wire", "bitwidth" : 256, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "local_l3_weights", "interface" : "memory", "bitwidth" : 256, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ l3_input sc_in sc_lv 256 signal 0 } 
	...
	{ local_l3_weights_address0 sc_out sc_lv 4 signal 5 } 
	{ local_l3_weights_ce0 sc_out sc_logic 1 signal 5 } 
	{ local_l3_weights_q0 sc_in sc_lv 256 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "l3_input", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "l3_input", "role": "default" }} , 
 	...
 	{ "name": "local_l3_weights_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "local_l3_weights", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	l3_input { ap_none {  { l3_input in_data 0 256 } } }
	...
	local_l3_weights { ap_memory {  { local_l3_weights_address0 mem_address 1 4 }  { local_l3_weights_ce0 mem_ce 1 1 }  { local_l3_weights_q0 mem_dout 0 256 } } }
}
