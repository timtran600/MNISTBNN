; ModuleID = 'C:/GitRepos/MNISTBNN/Project/phase2_hls/vitis/bnn_top/bnn_top/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_bnn_top_ir(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(8) %output_stream, %"struct.ap_uint<784>"* nocapture readonly %input, %"struct.ap_uint<784>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="256" "maxi" %l1_weights, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="256" "maxi" %l2_weights, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="10" "maxi" %l3_weights, %"struct.ap_uint<1>"* nocapture readonly %load_weights) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* nonnull %output_stream, i16* nonnull align 512 %output_stream_copy.data, i2* nonnull align 512 %output_stream_copy.keep, i2* nonnull align 512 %output_stream_copy.strb, i1* nonnull align 512 %output_stream_copy.last, [256 x %"struct.ap_uint<784>"]* nonnull %0, [256 x i784]* %l1_weights_copy, [256 x %"struct.ap_uint<256>"]* nonnull %1, [256 x i256]* %l2_weights_copy, [10 x %"struct.ap_uint<256>"]* nonnull %2, [10 x i256]* nonnull align 512 %l3_weights_copy)
  call void @apatb_bnn_top_hw(i16* %output_stream_copy.data, i2* %output_stream_copy.keep, i2* %output_stream_copy.strb, i1* %output_stream_copy.last, %"struct.ap_uint<784>"* %input, [256 x i784]* %l1_weights_copy, [256 x i256]* %l2_weights_copy, [10 x i256]* %l3_weights_copy, %"struct.ap_uint<1>"* %load_weights)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %output_stream, i16* %output_stream_copy.data, i2* %output_stream_copy.keep, i2* %output_stream_copy.strb, i1* %output_stream_copy.last, [256 x %"struct.ap_uint<784>"]* %0, [256 x i784]* %l1_weights_copy, [256 x %"struct.ap_uint<256>"]* %1, [256 x i256]* %l2_weights_copy, [10 x %"struct.ap_uint<256>"]* %2, [10 x i256]* %l3_weights_copy)
...
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [256 x %"struct.ap_uint<784>"]* noalias readonly "unpacked"="2", [256 x i784]* noalias nocapture "unpacked"="3.0", [256 x %"struct.ap_uint<256>"]* noalias readonly "unpacked"="4", [256 x i256]* noalias nocapture "unpacked"="5.0", [10 x %"struct.ap_uint<256>"]* noalias readonly "unpacked"="6", [10 x i256]* noalias nocapture align 512 "unpacked"="7.0") unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>.42"(i16* align 512 %_V_data_V, i2* align 512 %_V_keep_V, i2* align 512 %_V_strb_V, i1* align 512 %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0a256struct.ap_uint<784>"([256 x i784]* %2, [256 x %"struct.ap_uint<784>"]* %1)
  call fastcc void @"onebyonecpy_hls.p0a256struct.ap_uint<256>.18"([256 x i256]* %4, [256 x %"struct.ap_uint<256>"]* %3)
  call fastcc void @"onebyonecpy_hls.p0a10struct.ap_uint<256>"([10 x i256]* align 512 %6, [10 x %"struct.ap_uint<256>"]* %5)
  ret void
}
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [256 x %"struct.ap_uint<784>"]* noalias "unpacked"="2", [256 x i784]* noalias nocapture readonly "unpacked"="3.0", [256 x %"struct.ap_uint<256>"]* noalias "unpacked"="4", [256 x i256]* noalias nocapture readonly "unpacked"="5.0", [10 x %"struct.ap_uint<256>"]* noalias "unpacked"="6", [10 x i256]* noalias nocapture readonly align 512 "unpacked"="7.0") unnamed_addr #6 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a256struct.ap_uint<784>.29"([256 x %"struct.ap_uint<784>"]* %1, [256 x i784]* %2)
  call fastcc void @"onebyonecpy_hls.p0a256struct.ap_uint<256>"([256 x %"struct.ap_uint<256>"]* %3, [256 x i256]* %4)
  call fastcc void @"onebyonecpy_hls.p0a10struct.ap_uint<256>.8"([10 x %"struct.ap_uint<256>"]* %5, [10 x i256]* align 512 %6)
  ret void
}
...
declare void @apatb_bnn_top_hw(i16*, i2*, i2*, i1*, %"struct.ap_uint<784>"*, [256 x i784]*, [256 x i256]*, [10 x i256]*, %"struct.ap_uint<1>"*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [256 x %"struct.ap_uint<784>"]* noalias "unpacked"="2", [256 x i784]* noalias nocapture readonly "unpacked"="3.0", [256 x %"struct.ap_uint<256>"]* noalias "unpacked"="4", [256 x i256]* noalias nocapture readonly "unpacked"="5.0", [10 x %"struct.ap_uint<256>"]* noalias "unpacked"="6", [10 x i256]* noalias nocapture readonly align 512 "unpacked"="7.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %0, i16* align 512 %_V_data_V, i2* align 512 %_V_keep_V, i2* align 512 %_V_strb_V, i1* align 512 %_V_last_V)
  ret void
}

define void @bnn_top_hw_stub_wrapper(i16*, i2*, i2*, i1*, %"struct.ap_uint<784>"*, [256 x i784]*, [256 x i256]*, [10 x i256]*, %"struct.ap_uint<1>"*) #7 {
entry:
  %9 = alloca %"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"
  %malloccall = tail call i8* @malloc(i64 32768)
  %10 = bitcast i8* %malloccall to [256 x %"struct.ap_uint<784>"]*
  %malloccall1 = tail call i8* @malloc(i64 8192)
  %11 = bitcast i8* %malloccall1 to [256 x %"struct.ap_uint<256>"]*
  %12 = alloca [10 x %"struct.ap_uint<256>"]
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %9, i16* %0, i2* %1, i2* %2, i1* %3, [256 x %"struct.ap_uint<784>"]* %10, [256 x i784]* %5, [256 x %"struct.ap_uint<256>"]* %11, [256 x i256]* %6, [10 x %"struct.ap_uint<256>"]* %12, [10 x i256]* %7)
  %13 = bitcast [256 x %"struct.ap_uint<784>"]* %10 to %"struct.ap_uint<784>"*
  %14 = bitcast [256 x %"struct.ap_uint<256>"]* %11 to %"struct.ap_uint<256>"*
  %15 = bitcast [10 x %"struct.ap_uint<256>"]* %12 to %"struct.ap_uint<256>"*
  call void @bnn_top_hw_stub(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %9, %"struct.ap_uint<784>"* %4, %"struct.ap_uint<784>"* %13, %"struct.ap_uint<256>"* %14, %"struct.ap_uint<256>"* %15, %"struct.ap_uint<1>"* %8)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %9, i16* %0, i2* %1, i2* %2, i1* %3, [256 x %"struct.ap_uint<784>"]* %10, [256 x i784]* %5, [256 x %"struct.ap_uint<256>"]* %11, [256 x i256]* %6, [10 x %"struct.ap_uint<256>"]* %12, [10 x i256]* %7)
  ret void
}

declare void @bnn_top_hw_stub(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"struct.ap_uint<784>"* nocapture readonly, %"struct.ap_uint<784>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<1>"* nocapture readonly)
