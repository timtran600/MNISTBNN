set moduleName bnn_top_Pipeline_L3_LOAD
set isTopModule 0
...
set C_modelName {bnn_top_Pipeline_L3_LOAD}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_l3_weights { MEM_WIDTH 256 MEM_SIZE 320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "l3_weights","offset": { "type": "dynamic","port_name": "l3_weights","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "local_l3_weights", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY", "extern" : 0} ]}
