set SynModuleInfo {
  {SRCNAME bnn_layer1_xnor_Pipeline_POPCOUNT_LOOP MODELNAME bnn_layer1_xnor_Pipeline_POPCOUNT_LOOP RTLNAME bnn_layer1_xnor_bnn_layer1_xnor_Pipeline_POPCOUNT_LOOP
    SUBMODULES {
  ...
  {SRCNAME bnn_layer1_xnor MODELNAME bnn_layer1_xnor RTLNAME bnn_layer1_xnor IS_TOP 1
    SUBMODULES {
      {MODELNAME bnn_layer1_xnor_gmem_m_axi RTLNAME bnn_layer1_xnor_gmem_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
