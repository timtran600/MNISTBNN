...
// ==============================================================
`timescale 1ns/1ps
module bnn_layer1_xnor_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_OUTPUT_R_DATA_0     = 8'h78,
    ADDR_OUTPUT_R_DATA_1     = 8'h7c,
    ADDR_OUTPUT_R_CTRL       = 8'h80,
    ADDR_WEIGHTS_DATA_0      = 8'h84,
    ADDR_WEIGHTS_DATA_1      = 8'h88,
    ADDR_WEIGHTS_CTRL        = 8'h8c,
    ADDR_LOAD_WEIGHTS_DATA_0 = 8'h90,
    ADDR_LOAD_WEIGHTS_CTRL   = 8'h94,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
