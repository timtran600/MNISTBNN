set moduleName bnn_layer1_xnor_Pipeline_LOAD_LOOP
set isTopModule 0
...
set C_modelName {bnn_layer1_xnor_Pipeline_LOAD_LOOP}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_weights { MEM_WIDTH 784 MEM_SIZE 25088 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem1 int 1024 regular {axi_master 0}  }
	{ sext_ln22 int 57 regular  }
	{ local_weights int 784 regular {array 256 { 3 0 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 1024, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weights","offset": { "type": "dynamic","port_name": "weights","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln22", "interface" : "wire", "bitwidth" : 57, "direction" : "READONLY"} , 
 	{ "Name" : "local_weights", "interface" : "memory", "bitwidth" : 784, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ m_axi_gmem1_WDATA sc_out sc_lv 1024 signal 0 } 
	{ m_axi_gmem1_WSTRB sc_out sc_lv 128 signal 0 } 
	...
	{ m_axi_gmem1_RDATA sc_in sc_lv 1024 signal 0 } 
	...
	{ sext_ln22 sc_in sc_lv 57 signal 1 } 
	{ local_weights_address1 sc_out sc_lv 8 signal 2 } 
	{ local_weights_ce1 sc_out sc_logic 1 signal 2 } 
	{ local_weights_we1 sc_out sc_logic 1 signal 2 } 
	{ local_weights_d1 sc_out sc_lv 784 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln22", "direction": "in", "datatype": "sc_lv", "bitwidth":57, "type": "signal", "bundle":{"name": "sext_ln22", "role": "default" }} , 
 	{ "name": "local_weights_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_weights", "role": "address1" }} , 
 	{ "name": "local_weights_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_weights", "role": "ce1" }} , 
 	{ "name": "local_weights_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_weights", "role": "we1" }} , 
 	{ "name": "local_weights_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":784, "type": "signal", "bundle":{"name": "local_weights", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_gmem1_AWVALID VALID 1 1 }  { m_axi_gmem1_AWREADY READY 0 1 }  { m_axi_gmem1_AWADDR ADDR 1 64 }  { m_axi_gmem1_AWID ID 1 1 }  { m_axi_gmem1_AWLEN SIZE 1 32 }  { m_axi_gmem1_AWSIZE BURST 1 3 }  { m_axi_gmem1_AWBURST LOCK 1 2 }  { m_axi_gmem1_AWLOCK CACHE 1 2 }  { m_axi_gmem1_AWCACHE PROT 1 4 }  { m_axi_gmem1_AWPROT QOS 1 3 }  { m_axi_gmem1_AWQOS REGION 1 4 }  { m_axi_gmem1_AWREGION USER 1 4 }  { m_axi_gmem1_AWUSER DATA 1 1 }  { m_axi_gmem1_WVALID VALID 1 1 }  { m_axi_gmem1_WREADY READY 0 1 }  { m_axi_gmem1_WDATA FIFONUM 1 1024 }  { m_axi_gmem1_WSTRB STRB 1 128 }  { m_axi_gmem1_WLAST LAST 1 1 }  { m_axi_gmem1_WID ID 1 1 }  { m_axi_gmem1_WUSER DATA 1 1 }  { m_axi_gmem1_ARVALID VALID 1 1 }  { m_axi_gmem1_ARREADY READY 0 1 }  { m_axi_gmem1_ARADDR ADDR 1 64 }  { m_axi_gmem1_ARID ID 1 1 }  { m_axi_gmem1_ARLEN SIZE 1 32 }  { m_axi_gmem1_ARSIZE BURST 1 3 }  { m_axi_gmem1_ARBURST LOCK 1 2 }  { m_axi_gmem1_ARLOCK CACHE 1 2 }  { m_axi_gmem1_ARCACHE PROT 1 4 }  { m_axi_gmem1_ARPROT QOS 1 3 }  { m_axi_gmem1_ARQOS REGION 1 4 }  { m_axi_gmem1_ARREGION USER 1 4 }  { m_axi_gmem1_ARUSER DATA 1 1 }  { m_axi_gmem1_RVALID VALID 0 1 }  { m_axi_gmem1_RREADY READY 1 1 }  { m_axi_gmem1_RDATA FIFONUM 0 1024 }  { m_axi_gmem1_RLAST LAST 0 1 }  { m_axi_gmem1_RID ID 0 1 }  { m_axi_gmem1_RFIFONUM LEN 0 9 }  { m_axi_gmem1_RUSER DATA 0 1 }  { m_axi_gmem1_RRESP RESP 0 2 }  { m_axi_gmem1_BVALID VALID 0 1 }  { m_axi_gmem1_BREADY READY 1 1 }  { m_axi_gmem1_BRESP RESP 0 2 }  { m_axi_gmem1_BID ID 0 1 }  { m_axi_gmem1_BUSER DATA 0 1 } } }
	sext_ln22 { ap_none {  { sext_ln22 in_data 0 57 } } }
	local_weights { ap_memory {  { local_weights_address1 MemPortADDR2 1 8 }  { local_weights_ce1 MemPortCE2 1 1 }  { local_weights_we1 MemPortWE2 1 1 }  { local_weights_d1 MemPortDIN2 1 784 } } }
}
