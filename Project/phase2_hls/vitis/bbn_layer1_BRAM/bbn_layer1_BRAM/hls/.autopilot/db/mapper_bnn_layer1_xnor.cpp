...
extern "C" void bnn_layer1_xnor(Byte<2>*, Byte<128>*, __cosim_s128__*, int, int, __cosim_s1__);
extern "C" void apatb_bnn_layer1_xnor_hw(__cosim_s128__* __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, volatile void * __xlx_apatb_param_weights, __cosim_s1__* __xlx_apatb_param_load_weights) {
...
__xlx_weights__tmp_vec.push_back(((Byte<128>*)__xlx_apatb_param_weights)[i]);
  ...
  // DUT call
  bnn_layer1_xnor(__xlx_output_r__tmp_vec.data(), __xlx_weights__tmp_vec.data(), __xlx_apatb_param_input_r, __xlx_offset_byte_param_output_r, __xlx_offset_byte_param_weights, *__xlx_apatb_param_load_weights);
