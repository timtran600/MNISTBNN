...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { local_weights_address1 { O 8 vector } local_weights_ce1 { O 1 bit } local_weights_we1 { O 1 bit } local_weights_d1 { O 784 vector } } \
} "
} else {
...
set InstName bnn_layer1_xnor_flow_control_loop_pipe_sequential_init_U
set CompName bnn_layer1_xnor_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix bnn_layer1_xnor_ \
}"
} else {
