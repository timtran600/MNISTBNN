; ModuleID = 'C:/GitRepos/EECE4632/Project/phase2_hls/vitis/bnn_layer1_Stream_BRAM/bnn_layer1_Stream_BRAM/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_bnn_layer1_xnor_ir(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(8) %output_stream, %"struct.ap_uint<784>"* nocapture readonly %input, %"struct.ap_uint<784>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="256" "maxi" %weights, %"struct.ap_uint<1>"* nocapture readonly %load_weights) local_unnamed_addr #0 {
entry:
  ...
  %weights_copy = bitcast i8* %malloccall to [256 x i784]*
  %0 = bitcast %"struct.ap_uint<784>"* %weights to [256 x %"struct.ap_uint<784>"]*
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* nonnull %output_stream, i16* nonnull align 512 %output_stream_copy.data, i2* nonnull align 512 %output_stream_copy.keep, i2* nonnull align 512 %output_stream_copy.strb, i1* nonnull align 512 %output_stream_copy.last, [256 x %"struct.ap_uint<784>"]* nonnull %0, [256 x i784]* %weights_copy)
  call void @apatb_bnn_layer1_xnor_hw(i16* %output_stream_copy.data, i2* %output_stream_copy.keep, i2* %output_stream_copy.strb, i1* %output_stream_copy.last, %"struct.ap_uint<784>"* %input, [256 x i784]* %weights_copy, %"struct.ap_uint<1>"* %load_weights)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %output_stream, i16* %output_stream_copy.data, i2* %output_stream_copy.keep, i2* %output_stream_copy.strb, i1* %output_stream_copy.last, [256 x %"struct.ap_uint<784>"]* %0, [256 x i784]* %weights_copy)
...
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [256 x %"struct.ap_uint<784>"]* noalias readonly "unpacked"="2", [256 x i784]* noalias nocapture "unpacked"="3.0") unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [256 x %"struct.ap_uint<784>"]* noalias "unpacked"="2", [256 x i784]* noalias nocapture readonly "unpacked"="3.0") unnamed_addr #6 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a256struct.ap_uint<784>.6"([256 x %"struct.ap_uint<784>"]* %1, [256 x i784]* %2)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a256struct.ap_uint<784>.6"([256 x %"struct.ap_uint<784>"]* noalias "unpacked"="0" %dst, [256 x i784]* noalias nocapture readonly "unpacked"="1.0" %src) unnamed_addr #4 {
entry:
  %0 = icmp eq [256 x %"struct.ap_uint<784>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a256struct.ap_uint<784>.9"([256 x %"struct.ap_uint<784>"]* nonnull %dst, [256 x i784]* %src, i64 256)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a256struct.ap_uint<784>.9"([256 x %"struct.ap_uint<784>"]* "unpacked"="0" %dst, [256 x i784]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #5 {
entry:
  %0 = icmp eq [256 x %"struct.ap_uint<784>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
declare void @apatb_bnn_layer1_xnor_hw(i16*, i2*, i2*, i1*, %"struct.ap_uint<784>"*, [256 x i784]*, %"struct.ap_uint<1>"*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [256 x %"struct.ap_uint<784>"]* noalias "unpacked"="2", [256 x i784]* noalias nocapture readonly "unpacked"="3.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %0, i16* align 512 %_V_data_V, i2* align 512 %_V_keep_V, i2* align 512 %_V_strb_V, i1* align 512 %_V_last_V)
  ret void
}

define void @bnn_layer1_xnor_hw_stub_wrapper(i16*, i2*, i2*, i1*, %"struct.ap_uint<784>"*, [256 x i784]*, %"struct.ap_uint<1>"*) #7 {
entry:
  %7 = alloca %"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"
  %malloccall = tail call i8* @malloc(i64 32768)
  %8 = bitcast i8* %malloccall to [256 x %"struct.ap_uint<784>"]*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %7, i16* %0, i2* %1, i2* %2, i1* %3, [256 x %"struct.ap_uint<784>"]* %8, [256 x i784]* %5)
  %9 = bitcast [256 x %"struct.ap_uint<784>"]* %8 to %"struct.ap_uint<784>"*
  call void @bnn_layer1_xnor_hw_stub(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %7, %"struct.ap_uint<784>"* %4, %"struct.ap_uint<784>"* %9, %"struct.ap_uint<1>"* %6)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %7, i16* %0, i2* %1, i2* %2, i1* %3, [256 x %"struct.ap_uint<784>"]* %8, [256 x i784]* %5)
  ret void
}

declare void @bnn_layer1_xnor_hw_stub(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"struct.ap_uint<784>"* nocapture readonly, %"struct.ap_uint<784>"* noalias nocapture nonnull readonly, %"struct.ap_uint<1>"* nocapture readonly)
