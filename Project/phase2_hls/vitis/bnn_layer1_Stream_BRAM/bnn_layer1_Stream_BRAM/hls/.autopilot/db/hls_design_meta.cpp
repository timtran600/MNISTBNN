...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("output_stream_TDATA", 16, hls_out, 1, "axis", "out_data", 1),
	Port_Property("output_stream_TVALID", 1, hls_out, 4, "axis", "out_vld", 1),
	Port_Property("output_stream_TREADY", 1, hls_in, 4, "axis", "out_acc", 1),
	Port_Property("output_stream_TKEEP", 2, hls_out, 2, "axis", "out_data", 1),
	Port_Property("output_stream_TSTRB", 2, hls_out, 3, "axis", "out_data", 1),
	Port_Property("output_stream_TLAST", 1, hls_out, 4, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "bnn_layer1_xnor";
