set moduleName bnn_layer1_xnor_Pipeline_NEURON_LOOP
set isTopModule 0
...
set C_modelName {bnn_layer1_xnor_Pipeline_NEURON_LOOP}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_weights { MEM_WIDTH 784 MEM_SIZE 25088 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	...
	{ local_weights int 784 regular {array 256 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "wire", "bitwidth" : 784, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "local_weights", "interface" : "memory", "bitwidth" : 784, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ input_r sc_in sc_lv 784 signal 0 } 
	...
	{ local_weights_address0 sc_out sc_lv 8 signal 5 } 
	{ local_weights_ce0 sc_out sc_logic 1 signal 5 } 
	{ local_weights_q0 sc_in sc_lv 784 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_weights_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":784, "type": "signal", "bundle":{"name": "local_weights", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	local_weights { ap_memory {  { local_weights_address0 mem_address 1 8 }  { local_weights_ce0 mem_ce 1 1 }  { local_weights_q0 mem_dout 0 784 } } }
}
