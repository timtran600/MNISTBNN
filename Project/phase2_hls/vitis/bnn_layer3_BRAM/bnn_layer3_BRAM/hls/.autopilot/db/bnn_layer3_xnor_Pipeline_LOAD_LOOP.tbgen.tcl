set moduleName bnn_layer3_xnor_Pipeline_LOAD_LOOP
set isTopModule 0
...
set C_modelName {bnn_layer3_xnor_Pipeline_LOAD_LOOP}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_weights { MEM_WIDTH 256 MEM_SIZE 320 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem1 int 256 regular {axi_master 0}  }
	{ sext_ln22 int 59 regular  }
	{ local_weights int 256 regular {array 10 { 3 0 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ local_weights_address1 sc_out sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_weights_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "local_weights", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	...
	local_weights { ap_memory {  { local_weights_address1 MemPortADDR2 1 4 }  { local_weights_ce1 MemPortCE2 1 1 }  { local_weights_we1 MemPortWE2 1 1 }  { local_weights_d1 MemPortDIN2 1 256 } } }
}
