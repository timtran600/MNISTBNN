; ModuleID = 'C:/GitRepos/EECE4632/Project/phase2_hls/vitis/bnn_layer3_Stream_BRAM/bnn_layer3_Stream_BRAM/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_bnn_layer3_xnor_ir(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(8) %output_stream, %"struct.ap_uint<256>"* nocapture readonly %input, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="10" "maxi" %weights, %"struct.ap_uint<1>"* nocapture readonly %load_weights) local_unnamed_addr #0 {
entry:
  ...
  %0 = bitcast %"struct.ap_uint<256>"* %weights to [10 x %"struct.ap_uint<256>"]*
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* nonnull %output_stream, i16* nonnull align 512 %output_stream_copy.data, i2* nonnull align 512 %output_stream_copy.keep, i2* nonnull align 512 %output_stream_copy.strb, i1* nonnull align 512 %output_stream_copy.last, [10 x %"struct.ap_uint<256>"]* nonnull %0, [10 x i256]* nonnull align 512 %weights_copy)
  call void @apatb_bnn_layer3_xnor_hw(i16* %output_stream_copy.data, i2* %output_stream_copy.keep, i2* %output_stream_copy.strb, i1* %output_stream_copy.last, %"struct.ap_uint<256>"* %input, [10 x i256]* %weights_copy, %"struct.ap_uint<1>"* %load_weights)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %output_stream, i16* %output_stream_copy.data, i2* %output_stream_copy.keep, i2* %output_stream_copy.strb, i1* %output_stream_copy.last, [10 x %"struct.ap_uint<256>"]* %0, [10 x i256]* %weights_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [10 x %"struct.ap_uint<256>"]* noalias readonly "unpacked"="2", [10 x i256]* noalias nocapture align 512 "unpacked"="3.0") unnamed_addr #1 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a10struct.ap_uint<256>"([10 x i256]* align 512 %2, [10 x %"struct.ap_uint<256>"]* %1)
  ret void
}
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [10 x %"struct.ap_uint<256>"]* noalias "unpacked"="2", [10 x i256]* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #6 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a10struct.ap_uint<256>.6"([10 x %"struct.ap_uint<256>"]* %1, [10 x i256]* align 512 %2)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a10struct.ap_uint<256>.6"([10 x %"struct.ap_uint<256>"]* noalias "unpacked"="0" %dst, [10 x i256]* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a10struct.ap_uint<256>.9"([10 x %"struct.ap_uint<256>"]* "unpacked"="0" %dst, [10 x i256]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #5 {
entry:
  %0 = icmp eq [10 x %"struct.ap_uint<256>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
declare void @apatb_bnn_layer3_xnor_hw(i16*, i2*, i2*, i1*, %"struct.ap_uint<256>"*, [10 x i256]*, %"struct.ap_uint<1>"*)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias "unpacked"="0", i16* noalias align 512 "unpacked"="1.0" %_V_data_V, i2* noalias align 512 "unpacked"="1.1" %_V_keep_V, i2* noalias align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %_V_last_V, [10 x %"struct.ap_uint<256>"]* noalias "unpacked"="2", [10 x i256]* noalias nocapture readonly align 512 "unpacked"="3.0") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %0, i16* align 512 %_V_data_V, i2* align 512 %_V_keep_V, i2* align 512 %_V_strb_V, i1* align 512 %_V_last_V)
  ret void
}

define void @bnn_layer3_xnor_hw_stub_wrapper(i16*, i2*, i2*, i1*, %"struct.ap_uint<256>"*, [10 x i256]*, %"struct.ap_uint<1>"*) #7 {
entry:
  %7 = alloca %"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"
  %8 = alloca [10 x %"struct.ap_uint<256>"]
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %7, i16* %0, i2* %1, i2* %2, i1* %3, [10 x %"struct.ap_uint<256>"]* %8, [10 x i256]* %5)
  %9 = bitcast [10 x %"struct.ap_uint<256>"]* %8 to %"struct.ap_uint<256>"*
  call void @bnn_layer3_xnor_hw_stub(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %7, %"struct.ap_uint<256>"* %4, %"struct.ap_uint<256>"* %9, %"struct.ap_uint<1>"* %6)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* %7, i16* %0, i2* %1, i2* %2, i1* %3, [10 x %"struct.ap_uint<256>"]* %8, [10 x i256]* %5)
  ret void
}

declare void @bnn_layer3_xnor_hw_stub(%"class.hls::stream<hls::axis<ap_uint<16>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"struct.ap_uint<256>"* nocapture readonly, %"struct.ap_uint<256>"* noalias nocapture nonnull readonly, %"struct.ap_uint<1>"* nocapture readonly)
