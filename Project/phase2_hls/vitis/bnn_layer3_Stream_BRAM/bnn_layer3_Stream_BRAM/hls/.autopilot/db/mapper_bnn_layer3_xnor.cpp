...
__xlx_weights__tmp_vec.push_back(((Byte<32>*)__xlx_apatb_param_weights)[i]);
  ...
  int __xlx_size_param_weights = 10;
...
auto* soutput_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_last_V);
  // DUT call
  bnn_layer3_xnor(__xlx_weights__tmp_vec.data(), soutput_stream_V_data_V->data<short>(), soutput_stream_V_keep_V->data<char>(), soutput_stream_V_strb_V->data<char>(), soutput_stream_V_last_V->data<char>(), __xlx_apatb_param_input_r, __xlx_offset_byte_param_weights, *__xlx_apatb_param_load_weights);
