set SynModuleInfo {
  {SRCNAME bnn_top_Pipeline_RECV_INPUT MODELNAME bnn_top_Pipeline_RECV_INPUT RTLNAME bnn_top_bnn_top_Pipeline_RECV_INPUT
    SUBMODULES {
  ...
  {SRCNAME bnn_top MODELNAME bnn_top RTLNAME bnn_top IS_TOP 1
    SUBMODULES {
      {MODELNAME bnn_top_bnn_top_stream_stream_ap_uint_ap_uint_ap_uint_ap_uint_local_l1_weights_3_RAM_bkb RTLNAME bnn_top_bnn_top_stream_stream_ap_uint_ap_uint_ap_uint_ap_uint_local_l1_weights_3_RAM_bkb BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME bnn_top_bnn_top_stream_stream_ap_uint_ap_uint_ap_uint_ap_uint_local_l2_weights_3_RAM_fYi RTLNAME bnn_top_bnn_top_stream_stream_ap_uint_ap_uint_ap_uint_ap_uint_local_l2_weights_3_RAM_fYi BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME bnn_top_local_l3_weights_RAM_1P_LUTRAM_1R1W RTLNAME bnn_top_local_l3_weights_RAM_1P_LUTRAM_1R1W BINDTYPE storage TYPE ram_1p IMPL lutram LATENCY 2 ALLOW_PRAGMA 1}
