...
extern "C" void bnn_top(Byte<128>*, Byte<32>*, Byte<32>*, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int, int, __cosim_s1__);
extern "C" void apatb_bnn_top_hw(volatile void * __xlx_apatb_param_input_stream_V_data_V, volatile void * __xlx_apatb_param_input_stream_V_keep_V, volatile void * __xlx_apatb_param_input_stream_V_strb_V, volatile void * __xlx_apatb_param_input_stream_V_last_V, volatile void * __xlx_apatb_param_output_stream_V_data_V, volatile void * __xlx_apatb_param_output_stream_V_keep_V, volatile void * __xlx_apatb_param_output_stream_V_strb_V, volatile void * __xlx_apatb_param_output_stream_V_last_V, volatile void * __xlx_apatb_param_l1_weights, volatile void * __xlx_apatb_param_l2_weights, volatile void * __xlx_apatb_param_l3_weights, __cosim_s1__* __xlx_apatb_param_load_weights) {
using hls::sim::createStream;
  // Collect __xlx_l1_weights__tmp_vec
std::vector<Byte<128>> __xlx_l1_weights__tmp_vec;
for (size_t i = 0; i < 256; ++i){
__xlx_l1_weights__tmp_vec.push_back(((Byte<128>*)__xlx_apatb_param_l1_weights)[i]);
}
  int __xlx_size_param_l1_weights = 256;
  int __xlx_offset_param_l1_weights = 0;
  int __xlx_offset_byte_param_l1_weights = 0*128;
  // Collect __xlx_l2_weights__tmp_vec
std::vector<Byte<32>> __xlx_l2_weights__tmp_vec;
for (size_t i = 0; i < 256; ++i){
__xlx_l2_weights__tmp_vec.push_back(((Byte<32>*)__xlx_apatb_param_l2_weights)[i]);
}
  int __xlx_size_param_l2_weights = 256;
  int __xlx_offset_param_l2_weights = 0;
  int __xlx_offset_byte_param_l2_weights = 0*32;
  // Collect __xlx_l3_weights__tmp_vec
std::vector<Byte<32>> __xlx_l3_weights__tmp_vec;
for (size_t i = 0; i < 10; ++i){
__xlx_l3_weights__tmp_vec.push_back(((Byte<32>*)__xlx_apatb_param_l3_weights)[i]);
}
  int __xlx_size_param_l3_weights = 10;
  int __xlx_offset_param_l3_weights = 0;
  int __xlx_offset_byte_param_l3_weights = 0*32;
...
auto* sinput_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_input_stream_V_last_V);
  ...
  short* __xlx_output_stream_V_data_V_input_buffer= new short[ap_apatb_output_stream_V_data_V_cap_bc];
auto* soutput_stream_V_data_V = createStream((hls::stream<short>*)__xlx_apatb_param_output_stream_V_data_V);
...
auto* soutput_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_last_V);
  // DUT call
  bnn_top(__xlx_l1_weights__tmp_vec.data(), __xlx_l2_weights__tmp_vec.data(), __xlx_l3_weights__tmp_vec.data(), sinput_stream_V_data_V->data<int>(), sinput_stream_V_keep_V->data<char>(), sinput_stream_V_strb_V->data<char>(), sinput_stream_V_last_V->data<char>(), soutput_stream_V_data_V->data<short>(), soutput_stream_V_keep_V->data<char>(), soutput_stream_V_strb_V->data<char>(), soutput_stream_V_last_V->data<char>(), __xlx_offset_byte_param_l1_weights, __xlx_offset_byte_param_l2_weights, __xlx_offset_byte_param_l3_weights, *__xlx_apatb_param_load_weights);
// print __xlx_apatb_param_l1_weights
for (size_t i = 0; i < __xlx_size_param_l1_weights; ++i) {
((Byte<128>*)__xlx_apatb_param_l1_weights)[i] = __xlx_l1_weights__tmp_vec[__xlx_offset_param_l1_weights+i];
}
// print __xlx_apatb_param_l2_weights
for (size_t i = 0; i < __xlx_size_param_l2_weights; ++i) {
((Byte<32>*)__xlx_apatb_param_l2_weights)[i] = __xlx_l2_weights__tmp_vec[__xlx_offset_param_l2_weights+i];
}
// print __xlx_apatb_param_l3_weights
for (size_t i = 0; i < __xlx_size_param_l3_weights; ++i) {
((Byte<32>*)__xlx_apatb_param_l3_weights)[i] = __xlx_l3_weights__tmp_vec[__xlx_offset_param_l3_weights+i];
}
...
soutput_stream_V_data_V->transfer((hls::stream<short>*)__xlx_apatb_param_output_stream_V_data_V);
