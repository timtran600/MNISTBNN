...
__attribute__((sdx_kernel("bnn_layer2_xnor", 0))) void bnn_layer2_xnor(
    input_t input,
    output_t output[256],
    weight_row_t weights[256],
...
{
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=bnn_layer2_xnor
# 9 "bnn_layer2.cpp"
