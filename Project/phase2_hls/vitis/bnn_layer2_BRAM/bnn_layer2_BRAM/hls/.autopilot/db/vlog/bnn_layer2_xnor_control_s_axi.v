...
// ==============================================================
`timescale 1ns/1ps
module bnn_layer2_xnor_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_INPUT_R_DATA_2      = 7'h18,
    ADDR_INPUT_R_DATA_3      = 7'h1c,
    ADDR_INPUT_R_DATA_4      = 7'h20,
    ADDR_INPUT_R_DATA_5      = 7'h24,
    ADDR_INPUT_R_DATA_6      = 7'h28,
    ADDR_INPUT_R_DATA_7      = 7'h2c,
    ADDR_INPUT_R_CTRL        = 7'h30,
    ADDR_OUTPUT_R_DATA_0     = 7'h34,
    ADDR_OUTPUT_R_DATA_1     = 7'h38,
    ADDR_OUTPUT_R_CTRL       = 7'h3c,
    ADDR_WEIGHTS_DATA_0      = 7'h40,
    ADDR_WEIGHTS_DATA_1      = 7'h44,
    ADDR_WEIGHTS_CTRL        = 7'h48,
    ADDR_LOAD_WEIGHTS_DATA_0 = 7'h4c,
    ADDR_LOAD_WEIGHTS_CTRL   = 7'h50,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
