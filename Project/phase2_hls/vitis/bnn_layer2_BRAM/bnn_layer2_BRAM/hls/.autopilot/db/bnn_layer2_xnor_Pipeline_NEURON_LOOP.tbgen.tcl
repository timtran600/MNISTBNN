set moduleName bnn_layer2_xnor_Pipeline_NEURON_LOOP
set isTopModule 0
...
set C_modelName {bnn_layer2_xnor_Pipeline_NEURON_LOOP}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_weights { MEM_WIDTH 256 MEM_SIZE 8192 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem0 int 16 regular {axi_master 1}  }
	{ sext_ln30 int 63 regular  }
	{ input_r int 256 regular  }
	{ local_weights int 256 regular {array 256 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	...
	local_weights { ap_memory {  { local_weights_address0 mem_address 1 8 }  { local_weights_ce0 mem_ce 1 1 }  { local_weights_q0 mem_dout 0 256 } } }
}
