...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_stream_TREADY { I 1 bit } output_stream_TDATA { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { local_weights_address0 { O 8 vector } local_weights_ce0 { O 1 bit } local_weights_q0 { I 256 vector } } \
} "
} else {
...
set InstName bnn_layer2_xnor_flow_control_loop_pipe_sequential_init_U
set CompName bnn_layer2_xnor_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix bnn_layer2_xnor_ \
}"
} else {
