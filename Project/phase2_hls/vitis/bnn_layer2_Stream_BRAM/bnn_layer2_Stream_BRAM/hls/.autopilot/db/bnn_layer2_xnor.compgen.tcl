...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bnn_layer2_xnor_local_weights_RAM_2P_BRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bnn_layer2_xnor_gmem0_m_axi BINDTYPE {interface} TYPE {adapter} IMPL {m_axi}
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 11 \
			corename bnn_layer2_xnor_control_axilite \
			name bnn_layer2_xnor_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bnn_layer2_xnor_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bnn_layer2_xnor_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
