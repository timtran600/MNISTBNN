...
extern "C" void bnn_layer2_xnor(Byte<32>*, volatile void *, volatile void *, volatile void *, volatile void *, __cosim_s32__*, int, __cosim_s1__);
extern "C" void apatb_bnn_layer2_xnor_hw(volatile void * __xlx_apatb_param_output_stream_V_data_V, volatile void * __xlx_apatb_param_output_stream_V_keep_V, volatile void * __xlx_apatb_param_output_stream_V_strb_V, volatile void * __xlx_apatb_param_output_stream_V_last_V, __cosim_s32__* __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_weights, __cosim_s1__* __xlx_apatb_param_load_weights) {
using hls::sim::createStream;
  // Collect __xlx_weights__tmp_vec
std::vector<Byte<32>> __xlx_weights__tmp_vec;
for (size_t i = 0; i < 256; ++i){
__xlx_weights__tmp_vec.push_back(((Byte<32>*)__xlx_apatb_param_weights)[i]);
}
  int __xlx_size_param_weights = 256;
  int __xlx_offset_param_weights = 0;
  int __xlx_offset_byte_param_weights = 0*32;
...
auto* soutput_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_last_V);
  // DUT call
  bnn_layer2_xnor(__xlx_weights__tmp_vec.data(), soutput_stream_V_data_V->data<short>(), soutput_stream_V_keep_V->data<char>(), soutput_stream_V_strb_V->data<char>(), soutput_stream_V_last_V->data<char>(), __xlx_apatb_param_input_r, __xlx_offset_byte_param_weights, *__xlx_apatb_param_load_weights);
// print __xlx_apatb_param_weights
for (size_t i = 0; i < __xlx_size_param_weights; ++i) {
((Byte<32>*)__xlx_apatb_param_weights)[i] = __xlx_weights__tmp_vec[__xlx_offset_param_weights+i];
}
