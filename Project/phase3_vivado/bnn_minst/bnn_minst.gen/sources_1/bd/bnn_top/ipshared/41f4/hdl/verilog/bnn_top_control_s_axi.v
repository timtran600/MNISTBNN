...
localparam
    ...
    ADDR_IER                 = 6'h08,
    ADDR_ISR                 = 6'h0c,
    ADDR_L1_WEIGHTS_DATA_0   = 6'h10,
    ADDR_L1_WEIGHTS_DATA_1   = 6'h14,
    ADDR_L1_WEIGHTS_CTRL     = 6'h18,
    ADDR_L2_WEIGHTS_DATA_0   = 6'h1c,
    ADDR_L2_WEIGHTS_DATA_1   = 6'h20,
    ADDR_L2_WEIGHTS_CTRL     = 6'h24,
    ADDR_L3_WEIGHTS_DATA_0   = 6'h28,
    ADDR_L3_WEIGHTS_DATA_1   = 6'h2c,
    ADDR_L3_WEIGHTS_CTRL     = 6'h30,
    ADDR_LOAD_WEIGHTS_DATA_0 = 6'h34,
    ADDR_LOAD_WEIGHTS_CTRL   = 6'h38,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
