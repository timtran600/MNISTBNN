...
HD_PWD='C:/GitRepos/EECE4632/Project/phase3_vivado/bnn_minst/bnn_minst.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bnn_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bnn_top_wrapper.tcl -notrace
