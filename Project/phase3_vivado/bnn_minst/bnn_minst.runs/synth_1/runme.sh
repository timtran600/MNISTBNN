...
HD_PWD='C:/GitRepos/MNISTBNN/Project/phase3_vivado/bnn_minst/bnn_minst.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bnn_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bnn_top_wrapper.tcl
