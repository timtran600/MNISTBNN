...
HD_PWD='C:/GitRepos/EECE4632/Project/phase3_vivado/bnn_minst/bnn_minst.runs/bnn_top_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bnn_top_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bnn_top_rst_ps7_0_100M_0.tcl
