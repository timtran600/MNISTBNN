...
HD_PWD='C:/GitRepos/MNISTBNN/Project/phase3_vivado/bnn_minst/bnn_minst.runs/bnn_top_bnn_top_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bnn_top_bnn_top_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bnn_top_bnn_top_0_1.tcl
